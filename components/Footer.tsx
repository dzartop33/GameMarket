        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-zinc-400 text-sm">
              ...
              <Link href="/sell" className="hover:text-white transition">Продать</Link>
              <Link href="/sellers" className="hover:text-white transition">Продавцы</Link>
              <Link href="/deals" className="hover:text-white transition">Сделки</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-zinc-400 text-sm">
              ...
              <Link href="/wallet" className="hover:text-white transition">Кошелёк</Link>
              <Link href="/my-listings" className="hover:text-white transition">Мои объявления</Link>
              <Link href="/favorites" className="hover:text-white transition">Избранное</Link>
              <Link href="/messages" className="hover:text-white transition">Сообщения</Link>
            </div>
          </div>
